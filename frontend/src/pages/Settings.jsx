  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmModal
        ...
        message="Account deletion would be implemented in a real application."
        confirmLabel="Understood"
        variant="info"
        showCancel={false}
        onConfirm={acknowledgeDeleteInfo}
        onCancel={acknowledgeDeleteInfo}
      />
    </div>
  );
};
