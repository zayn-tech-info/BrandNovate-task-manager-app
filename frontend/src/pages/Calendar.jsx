    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-gray-400">View and manage your tasks by date</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                className="rounded-full p-2 text-gray-400 hover:bg-[#161926] hover:text-white"
          ...
          <div className="flex items-center space-x-2">
            <button
              className="btn border border-gray-800 bg-[#161926] text-white hover:border-white/5"
              onClick={goToToday}
            >
              Today
            </button>
            <div className="mx-2 h-6 border-r border-gray-800"></div>
            <div className="flex rounded-md border border-gray-800">
              <button
                className={`rounded-l-md border border-gray-800 px-4 py-2 text-sm font-medium ${
                  currentView === 'month'
                    ? 'bg-blue-600 text-white'
                    : 'bg-[#161926] text-gray-400 hover:border-white/5 hover:text-white'
                }`}
              ...
              <button
                className={`border-b border-r border-t border-gray-800 px-4 py-2 text-sm font-medium ${
                  currentView === 'week'
                    ? 'bg-blue-600 text-white'
                    : 'bg-[#161926] text-gray-400 hover:border-white/5 hover:text-white'
                }`}
              ...
              <button
                className={`rounded-r-md border-b border-r border-t border-gray-800 px-4 py-2 text-sm font-medium ${
                  currentView === 'day'
                    ? 'bg-blue-600 text-white'
                    : 'bg-[#161926] text-gray-400 hover:border-white/5 hover:text-white'
                }`}
        ...
        {currentView === 'month' && (
          <div>
            ...
            <div className="grid grid-cols-7 gap-px bg-gray-800">
              {weekDays.map((day) => (
                <div key={day} className="bg-[#111420] p-2 text-center text-sm font-medium text-gray-400">
                  {day}
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-7 gap-px bg-gray-800">
              {calendarDays.map((day, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`min-h-[100px] bg-[#111420] p-2 ${
                      !day.isCurrentMonth ? 'text-gray-600' : 'text-white'
                    } ${isCurrentDay ? 'bg-[#161926]' : ''} ${
                      isSelectedDay ? 'ring-2 ring-inset ring-blue-500/50' : ''
                    }`}
