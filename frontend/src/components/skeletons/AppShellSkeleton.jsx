...
const AppShellSkeleton = () => (
  <div className="flex h-screen bg-slate-100 dark:bg-[#0d0f14]">
    <aside className="hidden w-64 flex-col border-r border-slate-200 bg-white dark:border-white/5 dark:bg-[#0a0b0f] lg:flex">
      <Box className="flex h-16 items-center justify-center border-b border-slate-200 dark:border-white/5">
